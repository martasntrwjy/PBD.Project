...
function read_data() {
    ...
    <h2 class="tad" >Read Data Program Studi</h2>
    <table border=1 cellpadding="10">
        <tr>
            <td colspan="5"><a class="tvd" href="curd_prodi.php?a=input">INPUT</a></td>
        </tr>
        <tr class="tod">
            <td>ID</td>
            <td>KODE</td>
        ...
        <tr>
            ...
            <td>
                <a class="tid" href="curd_prodi.php?a=edit&id=<?php echo $row['idprodi']; ?>">EDIT</a>
                <a class="tud" href="curd_prodi.php?a=hapus&id=<?php echo $row['idprodi']; ?>">HAPUS</a>
            </td>
        </tr>
        <?php } ?>
    </table>
